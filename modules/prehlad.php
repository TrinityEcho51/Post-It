<div class="container-fluid">
    <div class="row">
        <div class="col-xs-6" id="Napis-Prihlaseny">
            <h5>Prihlaseny: Peter Fogel</h5></div>
        <div class="col-xs-6">
            <button class="btn btn-default" type="button" id="Odhlas">Odhlasit </button>
        </div>
    </div>
</div>
<div class="container-fluid">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table id="postitzoznam" data-toggle="table" data-striped="true" data-locale="sk-SK" data-pagination="true" page-size="10" data-search="true" data-show-columns="true" data-show-refresh="true" data-show-pagination-switch="true" data-url="php/readpostit.php" data-filter-control="true" data-show-toggle="true" data-filter-show-clear="true" data-show-export="true" data-export-types="['excel', 'pdf', 'csv']" data-export-options="{jspdf: {orientation: 'l'}}">
                    <thead>
                        <tr>
